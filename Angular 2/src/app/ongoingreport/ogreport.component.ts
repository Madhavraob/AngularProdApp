...
export class OnGoingReportComponent implements OnInit {
    ...
    show : boolean = true;
    test : any;
    editOngoingEleg=new FormGroup(
      {
          controlGroup            :new FormControl(null,[Validators.required] ),
          latestProductionCompany : new FormControl(),
          mostRecentShow          : new FormControl(),
    ...
    public onCellClick(data: any): any {
        this.test=data.row.controlGroup;
        console.log(data);
    }
