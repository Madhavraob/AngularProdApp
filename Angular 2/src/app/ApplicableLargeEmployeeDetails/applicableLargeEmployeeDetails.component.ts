...
import { ControlGroupService } from "../index";//test
...
export class ApplicableLargeEmployeeDetailsComponent implements OnInit {
    ...
    aleMap: Array<any>;
    ControlGroups: Array<any>=[{"cgid":24,"cg":"group1"},{"cgid":25,"cg":"group2"}];//test
    public ALEIDs: Array<any>=[{"aleid":11,"alen":"ALE1"},{"aleid":12,"alen":"ALE2"}];//test
    ...
    constructor(private _service: ApplicableLargeEmployeeDetailsService,private _controlservice: ControlGroupService) {
    ...
    ngOnInit(): void {
        ...
        console.log(this.aleMap);
        this.isEdit = false;
    }
    getControlGroupMap(): void {
        debugger;
        this._controlservice.getAllControlGroups().subscribe(value => {
